...
export const homeSections: Section[] = [
  ...
  },
  {
    ...
    props: {
      ...
      features: [
        { iconPath: '/cta/Layer_1.svg', label: 'Reliable Delivery', sublabel: 'On time, every time' },
        { iconPath: '/cta/Frame 209.svg', label: 'Client-Centric Approach', sublabel: 'You come first, always' },
        { iconPath: '/cta/Icons.svg', label: 'Scalable Solutions', sublabel: 'From idea to deployment' },
        { iconPath: '/cta/Frame 209 (1).svg', label: 'Seamless Execution', sublabel: 'From idea to delivery' },
